...
const CACHE = 'lunario-app-v36';
const RUNTIME_LIMIT = 60;   // сколько файлов статики держим на устройстве сверх оболочки
const SHELL = ['/app/', '/app/experience.css?v=36', '/app/moon-glass.css?v=36', '/app/experience.js?v=36', '/app/assets/fonts/onest-400-cyrillic.woff2', '/app/assets/fonts/onest-400-latin.woff2', '/app/assets/fonts/comfortaa-300-700-cyrillic.woff2', '/app/assets/fonts/comfortaa-300-700-latin.woff2', '/app/sky.js?v=36', '/app/sky-model.js?v=36', '/app/constellations.js?v=36', '/app/assets/moon-hero.png'];
