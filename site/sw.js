...
const V = '105';   /* одна версия для оболочки: index.html, sky.js и импорты внутри него ссылаются на тот же ?v= */
...
const SHELL = ['/app/', '/app/theme.css?v=' + V, '/app/app.css?v=' + V, '/app/frame.css?v=' + V,
  ...
  '/app/boot.js?v=' + V, '/app/moon-logo.js?v=' + V, '/app/common.js?v=' + V, '/app/experience.js?v=' + V, '/app/app.js?v=' + V, '/app/tour.js?v=' + V, '/app/handlers.js?v=' + V, '/app/on.js?v=' + V,
