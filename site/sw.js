...
const V = '111';   /* одна версия для оболочки: index.html, sky.js и импорты внутри него ссылаются на тот же ?v= */
...
const SHELL = ['/app/', '/app/theme.css?v=' + V, '/app/app.css?v=' + V, '/app/frame.css?v=' + V,
  ...
  '/app/boot.js?v=' + V, '/app/moon-logo.js?v=' + V, '/app/common.js?v=' + V, '/app/experience.js?v=' + V, '/app/app.js?v=' + V, '/app/today.js?v=' + V, '/app/diary.js?v=' + V, '/app/readings.js?v=' + V, '/app/practices.js?v=' + V, '/app/about.js?v=' + V, '/app/account.js?v=' + V, '/app/start.js?v=' + V, '/app/tour.js?v=' + V, '/app/handlers.js?v=' + V, '/app/on.js?v=' + V,
