...
const CACHE = 'lunario-app-v29';
const RUNTIME_LIMIT = 60;   // сколько файлов статики держим на устройстве сверх оболочки
const SHELL = ['/app/', '/app/experience.css?v=29', '/app/moon-glass.css?v=29', '/app/experience.js?v=29', '/app/assets/fonts/onest-400-cyrillic.woff2', '/app/assets/fonts/onest-400-latin.woff2', '/app/assets/fonts/comfortaa-300-700-cyrillic.woff2', '/app/assets/fonts/comfortaa-300-700-latin.woff2', '/app/sky.js?v=29', '/app/sky-model.js?v=29', '/app/constellations.js?v=29', '/app/assets/moon-hero.png'];
