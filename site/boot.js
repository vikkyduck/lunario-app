...
/* «Компактный вид» — основной с 17.09 (решение владелицы); «Обычный» остается по выбору: ?skin=classic или Аккаунт → Оформление. Выбор помнится на устройстве */
/* Корпус телефона на компьютере: при ширине окна от 700px приложение живет в рамке 430px (frame.css); на телефоне и в оболочке — как есть */
