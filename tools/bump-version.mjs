...
const FILES = { 'index.html': /\/app\/(?:theme\.css|experience\.css|moon-glass\.css|compact\.css|sky\.js|experience\.js|boot\.js|moon-logo\.js|app\.js|handlers\.js|on\.js)\?v=(\d+)/g,
