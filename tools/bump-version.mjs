...
const FILES = { 'index.html': /\/app\/(?:theme\.css|experience\.css|moon-glass\.css|compact\.css|frame\.css|sky\.js|experience\.js|boot\.js|moon-logo\.js|common\.js|app\.js|tour\.js|handlers\.js|on\.js)\?v=(\d+)/g,
