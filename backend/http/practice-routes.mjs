/* Практики дня: что уже сделано сегодня, дневник привычек и аскеза.
   ...
   · регулярность привычки человек задаёт словами, parseRule превращает их в правило;
   · награда за серию выдаётся один раз и только ежедневной привычке;
   · аскеза живёт до даты, а не «на N дней», и отметка — это наблюдение парой слов, а не галочка.
