/* Заголовки страниц — одно место для сервера и локального просмотра (tools/preview.mjs отдает index.html сам).
   ...
   и вешаются делегированием (on.js). Поэтому даже если в разметку попадет чужой текст, выполнить код он не сможет.
