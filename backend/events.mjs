...
export const EVENTS = [
  ...
  E('habit_award', 'Получил награду за привычку', 'server'),
  ...
  E('worry_pick', 'Разобрал вопрос', 'client', { core: true, section: 'Свериться', title: 'Разобрать вопрос' }),
  E('ask_yesno', 'Спросил «Да / Нет»', 'server', { core: true, section: 'Свериться', title: 'Да / Нет' }),
  E('ask_rune', 'Вытянул руну', 'server', { core: true, section: 'Свериться', title: 'Руны' }),
  E('ask_spread', 'Сделал расклад', 'server', { core: true, section: 'Свериться', title: 'Таро' }),
  ...
  E('natal_view', 'Открыл натальную карту', 'server', { core: true, section: 'Я', title: 'Натальная карта' }),
  E('compat_calc', 'Посчитал совместимость', 'server', { core: true, section: 'Я', title: 'Совместимость' }),
  ...
  E('reminder_on', 'Включил напоминание', 'server', { section: 'Я', title: 'Уведомления' }),
  ...
  E('installed', 'Установил на телефон', 'client', { section: 'Я', title: 'Установка на телефон' }),
  E('support_new', 'Написал в поддержку', 'server', { section: 'Я', title: 'Чат поддержки' }),
