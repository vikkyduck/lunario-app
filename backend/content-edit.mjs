...
export const TABLES = {
  ...
  'планеты-в-знаках.txt': { title: 'Натальная карта: планеты в знаках', cols: ['планета', 'знак', 'текст'] },
  'аспекты.txt': { title: 'Натальная карта: аспекты', cols: ['планета', 'аспект', 'планета', 'текст'] },
