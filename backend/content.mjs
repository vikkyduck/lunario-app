...
const REMINDER_TEXTS_FALLBACK = {
  ...
  evening: ['Пора запомнить этот день', 'Откройте Лунарио: три коротких вопроса, и день останется с вами'],
  'evening-2': ['Как прошел ваш день?', 'Заходите — запомним его вместе, это на минуту'],
  'evening-3': ['Минута для себя перед сном', 'Давайте запомним, чем был сегодняшний день'],
  'evening-4': ['День почти закончился', 'Откройте Лунарио и оставьте от него пару строк'],
