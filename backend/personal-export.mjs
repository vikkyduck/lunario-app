...
export function personalExport(db,u,open){
  ...
  return {version:1,exportedAt:new Date().toISOString(),profile:{name:u.name,birth:u.birth,birthTime:u.birth_time,city:u.city,email:u.email,photo:u.photo},journal,wishes,habits,askesis,
